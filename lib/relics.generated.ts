...
export const RELICS: Relic[] = [
  {
    ...
    name: "Acidic Slime",
    description: "Every 8 seconds, capture enemies within 800, dissolving up to 4 buffs or debuffs. Each 1 dissolves deals magic damage equal to 100–180% of all Attributes.",
  ...
  },
  {
    ...
    description: "Gain 2 Advanced Purification Potions. Purification Potions are 30–100% more effective in healing and damage.",
  ...
  },
  {
    ...
    description: "Gain 2 Advanced Ravage Potions. Ravage Potions you use are 30–100% more effective.",
  ...
  },
  {
    ...
    description: "Maximum HP Rune +0–3, restores 1 HP for every 3–6 Stage completed.",
  ...
  },
  {
    ...
    name: "Affinity",
    description: "Allied heroes (excluding you) leveling up grants 0.6–1.7 to all Attributes.",
  ...
  },
  {
    ...
    description: "At the start of each round, permanently convert 20% of your current base Strength and base Intelligence into base Agility with an extra conversion rate of 0–30%, gaining a minimum of 5. This effect cannot be reversed.",
  ...
  },
  {
    ...
    name: "Arcane Bottle",
    description: "Bottle maximum charges increased by 1–5. Activating the bottle immediately restores the same amount of charges.",
  ...
  },
  {
    ...
    name: "Blabber Guy",
    description: "Every 5 seconds, you produce a fart, dealing magic damage to enemies within 500 range. Damage = (25–45% of the damage you have taken during this period).",
  ...
  },
  {
    ...
    name: "Blasting",
    description: "3 seconds after death, trigger an explosion at the location, dealing pure damage to enemies within 300–700 equal to 200–320 + 15–40% of your Max HP.",
  ...
  },
  {
    ...
    name: "Blood Strike",
    description: "Deals bonus damage equal to (4–70 + 0.4–7% of your max HP). If your max HP is higher than 20000–70000, then this bonus is increased by 80%.",
  ...
  },
  {
    ...
    description: "At the start of each Stage, active Day and Night bonuses for 30–180 seconds.",
  ...
  },
  {
    ...
    name: "Complex",
    description: "Each secondary Attribute grants 0.2–0.3 Base Attack Damage. Does not affect Universal Heroes.",
  ...
  },
  {
    ...
    name: "Control Whip",
    description: "Every 10 Strength increases summoned unit HP by 0.4–1%. Every 10 Agility increases summoned unit Attack Damage by 0.3–0.8%. Every 10 Intelligence provides a 30% bonus effect to the other twoAttributes. (Additional Attributes are not counted.)",
  ...
  },
  {
    ...
    name: "Culler",
    description: "Deal 25–55% bonus damage to enemies with HP above 80%.",
  ...
  },
  {
    ...
    name: "Dawn Shelter",
    description: "Gain a shield equal to 4–8% of Max HP against all damage every 15 seconds. During daytime, the shield value is multiplied by 200%.",
  ...
  },
  {
    ...
    description: "Gain 2–4% Spell Amp on death. Max: 18–100%.",
  ...
  },
  {
    ...
    name: "Devil Mask",
    description: "At the start of the Stage gain 1 random Common Shard upgrades (lasts until Stage ends). 10–35% chance to permanently retain the upgrade. Max retained: 3.",
  ...
  },
  {
    ...
    name: "Dragon Coin",
    description: "At the start of each Stage, if your gold is below 200–650, it is immediately increased to 200–650.",
  ...
  },
  {
    ...
    name: "Dutybound",
    description: "For each dead ally, all Attributes are increased by 7–10%.",
  ...
  },
  {
    ...
    description: "Attacks have a 15% chance to spawn a spirit at the target’s location. The spirit attacks enemies within 600 every 0.5 seconds and has a 20–35% chance to disappear after each attack. Cooldown: 4 seconds.",
  ...
  },
  {
    ...
    name: "Embers",
    description: "Converts your current HP Runes into Embers. Each Ember increases Max HP by 5–10%. Upon death, 1 stacks are lost.",
  ...
  },
  {
    ...
    name: "Endless Bottle",
    description: "The Bottle restores 3 charges every 1–5 Stages.",
  ...
  },
  {
    ...
    description: "Attacks apply Poison equal to (3–10 × Depth + 8–22%Agility).",
  ...
  },
  {
    ...
    name: "Equilibrium",
    description: "When casting a spell with cooldown longer than 2 seconds, has a 25% chance to restore Mana equal to 20–35 + 1.5–4% of max MP.",
  ...
  },
  {
    ...
    name: "Fatal Kill",
    description: "The first Critical trike triggered against an enemies gains 40–120% bonus damage.",
  ...
  },
  {
    ...
    description: "When your trigger critical strike, if the target’s Health is below 20%, the final damage of that instance is increased by 70–150%.",
  ...
  },
  {
    ...
    name: "Fate Rewrite · I",
    description: "Free refreshes for Legendary Specter Shards +1–2.",
  ...
  },
  {
    ...
    description: "Free refreshes for Common Specter Shards +1–5.",
  ...
  },
  {
    ...
    description: "Your next attack will strike an additional 1 times after a short delay, dealing 40–300% damage and ignoring evasion. Cooldown: 1.5 seconds.",
  ...
  },
  {
    ...
    name: "Ghost Form",
    description: "Once per Stage, persist for 5–9 seconds upon death.",
  ...
  },
  {
    ...
    name: "Glass Cannon",
    description: "Damage you take is increased by 30–60%, but your final damage is increased by 15–35%.",
  ...
  },
  {
    ...
    name: "Gold Replica",
    description: "At the start of the Stage, gain 2–6 % interest bonus.",
  ...
  },
  {
    ...
    name: "Grow",
    description: "After each Act, your model size increases by 10–15%. All Attributes increased by 8–20% of current base value.",
  ...
  },
  {
    ...
    name: "Hunting Time",
    description: "Attack speed and Movement speed increased by 2–25%, with an additional bonus of 50% during nighttime.",
  ...
  },
  {
    ...
    description: "At the start of each round, permanently convert 20% of your current base Strength and base Agility into base Intelligence with an extra conversion rate of 0–30%, gaining a minimum of 5. This effect cannot be reversed.",
  ...
  },
  {
    ...
    name: "Ironclad",
    description: "Casting a spell grants a shield equal to 50–140% Strength, blocking all damage for 12 seconds. Cap: 50–100% of Max HP.",
  ...
  },
  {
    ...
    name: "Living Blood",
    description: "+0.5–1% health regen per second while health is above 80%, up to 80%. Decays by 300% per second when below the threshold.",
  ...
  },
  {
    ...
    name: "Living Water",
    description: "Converts current HP Runes into Living Water. Each stack increases max MP by 5–10%. Loses 1 stacks upon each death.",
  ...
  },
  {
    ...
    name: "Lone Wolf",
    description: "When there are no other allied units within 850–1500 range, all Attributes are increased by 8–15%.",
  ...
  },
  {
    ...
    name: "Lucky Potion",
    description: "Upon using the Bottle, the target gains 10–33 Luck Bonus for 90 seconds.",
  ...
  },
  {
    ...
    description: "Magic Damage penetrates 2–8+8–15% of the target's Magic Armor.",
  ...
  },
  {
    ...
    name: "Mana Strike",
    description: "+3–40% Orb-type Damage (+). While your current mana is above 25%, gain Attack Speed, reaching 5–50 at 80% mana.",
  ...
  },
  {
    ...
    description: "Bottle restoration effect increased by 40–100%.",
  ...
  },
  {
    ...
    description: "Gain 20–30% damage reduction. Mitigated damage is dealt over the next 6 seconds. Killing an enemy reduces remaining pending damage by 8–15%.",
  ...
  },
  {
    ...
    name: "Mystic Potion",
    description: "Upon using the Bottle, the target gains 15% Spell Amp for 15–70 seconds.",
  ...
  },
  {
    ...
    name: "Nature‘s Boon",
    description: "Heals all allied heroes every 10 seconds. Healing = 15–20 + 100–200% of your Health Regeneration.",
  ...
  },
  {
    ...
    name: "Night Stalker",
    description: "Killing an enemy restores 1.5–4% of HP and MP. During nighttime, the effect is increased to 200%.",
  ...
  },
  {
    ...
    description: "When any allied hero takes lethal damage, they gain a Shallow Grave effect for 3–5 seconds, preventing death. Cooldown: 120.",
  ...
  },
  {
    ...
    name: "Ocean Guard",
    description: "While in water terrain: Grants 15–25% Status Resistance and 15–25% Health and Mana Regeneration.",
  ...
  },
  {
    ...
    description: "Physical Damage penetrates 2–8+8–15% of the target's Armor.",
  ...
  },
  {
    ...
    description: "Healing you provide has a 20% chance to repeat once after a short delay, with the repeated effect at 8–23% effectiveness.",
  ...
  },
  {
    ...
    name: "Puppet Strings",
    description: "Summoned unit Attack Speed increased by 10–75.",
  ...
  },
  {
    ...
    name: "Raging Combo",
    description: "Gain 200 Attack Speed for next 6 attacks. Each attack deals Bonus Damage equal to 20–40% of your Attack Damage. Cooldown: 12–20 seconds after all charges used.",
    special: "+3 Attacks",
    isAttribute: false,
    weight: 100,
  ...
  },
  {
    ...
    name: "Rawhide",
    description: "Permanently increases HP by 40–90+0.5–1.2% per Round.",
  ...
  },
  {
    ...
    description: "Cannot perform Regular attacks. Releases up to 7 souls every 4 seconds that attack nearby enemies, each dealing 100–200% damage. Range: 35% of your bonus attack distance + 200–650. Release interval scales with Attack Speed.",
  ...
  },
  {
    ...
    description: "Ability damage dealt has a 18% chance to apply Reaper's Scythe. After a 1.5 second delay, deals magic damage to the target. Base damage is 25–70. Each point of missing HP increases damage by 0.2–0.5, up to a maximum bonus of 330–1000% of Primary Attributes. This effect has a 8 seconds cooldown per target.",
  ...
  },
  {
    ...
    description: "Emits heat, dealing magic damage per second equal to 1–2% of your Max Health to enemies within 200–350 range.",
  ...
  },
  {
    ...
    name: "Reviving Flame",
    description: "Infuses the Bottle with energy. On use: target gains +4–7 to all Attributes for 100 seconds. Stacks independently.",
  ...
  },
  {
    ...
    name: "Runner-up",
    description: "Upon completing a Stage without dying during it, gain 5–13 Bonus Base Attack Damage.",
  ...
  },
  {
    ...
    description: "While health is above 40%, takes 5% of max health as damage per second (ignores shields).Gains 0.2–4% health regen amplification per 6% health lost, stacking up to 0.3–3% at 95% health lost.",
  ...
  },
  {
    ...
    name: "Sadist",
    description: "Kills grant stacking effect: 0.3–3 Health Regeneration and Mana Regeneration per second. Bonus is multiplied by 2.5 against bosses. Lasts until the end of the Stage.",
  ...
  },
  {
    ...
    name: "Sealed Bottle",
    description: "Bottle cannot be actively used. Provides passive restoration at 2–10% effectiveness. Triggers a use every 23–80 seconds, activating other bonuses.",
  ...
  },
  {
    ...
    name: "Secrecy",
    description: "Backstab attacks deal additional damage equal to 20–80% of your Agility. Every 5 seconds, your next 1–7 attacks are guaranteed to be backstabs.",
  ...
  },
  {
    ...
    name: "Seed of Nature",
    description: "When Health falls below 30%, taking damage triggers Seed of Nature: negate damage, root and disarm all enemies within a 800 radius for 4–7 seconds. Self invulnerability for same duration. Cooldown: 2 Stages.",
  ...
  },
  {
    ...
    description: "Primary attributes increased by 4–30%. Each cast increases this bonus by 3% during this round, up to a maximum of 14–60%, but also Silences self for 2.5 seconds, reduced by cooldown reduction.",
  ...
  },
  {
    ...
    name: "Soul Return",
    description: "When a summon dies or expires, heals self for 60 + 5% HP and grants 1.5–4% Summon Amp. This effect stacks independently for 20 seconds, and can stack up to 6–22%.",
  ...
  },
  {
    ...
    description: "At the start of each round, permanently convert 20% of your current base Agility and base Intelligence into base Strength with an extra conversion rate of 0–30%, gaining a minimum of 5. This effect cannot be reversed.",
  ...
  },
  {
    ...
    name: "Thick Carapace",
    description: "Armor increased by 2–30+2–30%. Every 2 armor also provides 0.1–1.5 damage block, blocking up to 45% of incoming damage.",
  ...
  },
  {
    ...
    name: "Thirst",
    description: "Grants 2–30% Lifesteal from all damage sources. While Health is above 50%, dealing damage consumes 4% of Max Health to amplify final damage by 3–25%. This effect has a minimum interval of 0.2 seconds.",
  ...
  },
  {
    ...
    name: "Troll Blood",
    description: "If you take no damage for 5 seconds and are not at full Health, gain 0.4–6% Health Regeneration per second.",
  ...
  },
  {
    ...
    name: "Unity Prevails",
    description: "Upon entering Act III, immediately level up by 1–6 levels.",
  ...
  },
  {
    ...
    description: "Continuously digests one enemy within a 1300 radius, dealing magic damage equal to 20–50% of your Health Regeneration per second. While digesting, you gain 2% Health Regeneration AMP per second, up to 30%.",
  ...
  },
  {
    ...
    description: "Reduces the movement speed of enemies within 500 range based on their proximity to you, slowing them by up to (11–60 + 5–16%). Additionally, damage you take from them is reduced by up to 4–25%.",
  ...
  },
  {
    ...
    name: "Void Codex",
    description: "Casting has a 25% chance to reduce other Abilities' cooldown by 5–15%. Does not affect Ultimates.",
  ...
  },
  {
    ...
    description: "The Bottle additionally affects the nearest other allied hero within 200–700 range of the target.",
