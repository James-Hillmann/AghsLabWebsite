 ...
 *
 * Ordered roster, the three catalogues, then the two things you actually update as you play.
 *
...
export function SiteNav() {
  ...
  return (
    // Six links no longer fit one line on a phone, so they wrap. Tighter gap below sm
